    ...
    const whereCondition: Prisma.PeopleWhereInput = searchQuery
      ? {
          OR: [
            ...
            { permanent_address: { contains: searchQuery, mode: Prisma.QueryMode.insensitive } },
            { nid: { contains: searchQuery, mode: Prisma.QueryMode.insensitive } },
            ...
            { gender: { contains: searchQuery.toUpperCase(), mode: Prisma.QueryMode.insensitive } },
